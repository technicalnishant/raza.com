...
} from '../model/paypal.model'
import { ScriptService } from '../service/script.service';

@Component({
    changeDetection: ChangeDetectionStrategy.OnPush,
    selector: 'raza-paypal',
    template: `
    <div #payPalButtonContainer [id]="payPalButtonContainerId"></div>
    `
})
export class RazaPaypalComponent implements OnChanges, OnDestroy, AfterViewInit {
    ...
    */
    ...
    @ViewChild('payPalButtonContainer' ,{static: true}) set payPalButtonContainer(content: ElementRef) {
    ...
    private generateElementId(): string {
        return `raza-captcha-id-${new Date().valueOf()}`;
    }
