...
@Component({
  selector: 'app-buy-five-get-five',
  templateUrl: './buy-five-get-five.component.html',
  styleUrls: ['./buy-five-get-five.component.scss']
})
export class BuyFiveGetFiveComponent implements OnInit {
 ...
 this.promotionsService.getPromotion(this.currentSetting.currentCountryId, this.promotionCode).subscribe(
  ...
  buyNowClick(countryId)
  {
    this.OpenPlanDialog(countryId );
  }

  OpenPlanDialog(countryId ) {
