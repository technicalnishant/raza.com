...
@Component({
  selector: 'app-india-one-cent',
  templateUrl: './india-one-cent.component.html',
  styleUrls: ['./india-one-cent.component.scss']
})
export class IndiaOneCentComponent implements OnInit {
  promotion: Promotion;
  ...
  ngOnInit() {
    ...
    this.titleService.setTitle('India one cent plan');
  ...
  get LandingPageBanner() {
    ...
    return `url('assets/images/existingcustomers-d.png') no-repeat cover`;
  }
