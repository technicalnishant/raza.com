...
@Component({
  selector: 'app-mobile-rewards',
  templateUrl: './mobile-rewards.component.html',
  styleUrls: ['./mobile-rewards.component.scss']
})
export class MobileRewardsComponent implements OnInit {
