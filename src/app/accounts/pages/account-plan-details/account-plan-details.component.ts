...
@Component({
  selector: 'app-account-plan-details',
  templateUrl: './account-plan-details.component.html',
  styleUrls: ['./account-plan-details.component.scss']
})
export class AccountPlanDetailsComponent implements OnInit, OnDestroy {
