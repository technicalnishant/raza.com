...
@Component({
  selector: 'app-account-search-rates',
  templateUrl: './account-search-rates.component.html',
  styleUrls: ['./account-search-rates.component.scss']
})
export class AccountSearchRatesComponent implements OnInit {
  isSmallScreen;
  countryId:any;
    ...
    this.planService.getAllPlans().subscribe(
      (data: Plan[]) => {
        ...
        if(data.length > 0 )
        {
          ...
          this.countryId   = this.plan.CountryTo;
          this.getRates();
        }
