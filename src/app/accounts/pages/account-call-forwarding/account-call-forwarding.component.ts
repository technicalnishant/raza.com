...
@Component({
  selector: 'app-account-call-forwarding',
  templateUrl: './account-call-forwarding.component.html',
  styleUrls: ['./account-call-forwarding.component.scss']
})
export class AccountCallForwardingComponent implements OnInit {
  id: any = 1;
  dealselected: any = 1;
  planId: string;
