...
import { ViewChild, EventEmitter, Output, AfterViewInit, Input, NgZone } from '@angular/core';
 import { Observable, Subscription } from 'rxjs';

@Component({
  selector: 'app-add-creditcard-pay-dialog',
  templateUrl: './add-creditcard-pay-dialog.html',
})
export class AddCreditcardPayDialog implements OnInit, AfterViewInit {
...
/**********EOF Google place search **********/
  ...
  constructor(
    public zone: NgZone,
    public dialogRef: MatDialogRef<AddCreditcardPayDialog>,
