...
@Component({
  selector: 'app-add-creditcard-dialog',
  templateUrl: './add-creditcard-dialog.html',
})
export class AddCreditcardDialog implements OnInit, AfterViewInit {
/********** Google place search **********/
...
/**********EOF Google place search **********/
  ...
  constructor(
    ...
    public zone: NgZone,
    public dialogRef: MatDialogRef<AddCreditcardDialog>,
