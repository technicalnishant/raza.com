...
@Component({
  selector: 'app-global-call',
  templateUrl: './global-call.component.html',
  styleUrls: ['./global-call.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class GlobalCallComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<GlobalCallComponent>,
