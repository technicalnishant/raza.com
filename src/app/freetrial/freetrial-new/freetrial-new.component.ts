...
@Component({
  selector: 'app-freetrial-new',
  templateUrl: './freetrial-new.component.html',
  styleUrls: ['./freetrial-new.component.scss']
})
export class FreetrialNewComponent implements OnInit, OnDestroy {
